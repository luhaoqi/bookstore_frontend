        ...
        return cartItems.map((item) =>
            <div className="product">
                <figure className="book_window">
                    ...
                    <figcaption>￥{item.book.price}</figcaption>
                    <ul className="amount">
                        <Button className="first-item" onClick={(e)=>{this.handleDeleteFromCart(item.book.bid)}}> - </Button>
                        <li className="item">{item.num}</li>
                        <Button className="last-item" onClick={(e)=>{this.handleAddToCart(item.book.bid)}}> + </Button>
                    </ul>
                </figure>
            </div>
        );
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-12 col-7 order_list">
                            ...
                            <div><p className="base">总价:</p><p>{this.state.totPrice}￥</p></div>
                            <div><p className="base">折扣:</p><p>0 ￥</p></div>
                            <div><p className="base">总计:</p><p>{this.state.totPrice}￥ </p></div>
                        </div>
                    </div>
                </div>
            </div>
